...
/* 
Art Interactive Installation - 20 18
To expose with Arduino and proyected over the spectator.
Draw an energy fluid from plants.

-National University of Art (UNA) Argentina. Lenguaje Visual VII. Liliana Medela
-Kadenze, The Nature of Code. Steering Behaviors. Daniel Shiffman.
*/
...
function FlowField(r) {
  ...
  this.cols = (width/3) / this.resolution; // columnas = anchoPantalla / 3
